  ...
  return (
    <Container size="lg" paddingX={4} paddingY={8}>
      <Stack direction="vertical" spacing={8}>
        {/* Hero Section */}
        <Box className="nurav-hero text-center">
          <Stack direction="vertical" spacing={6}>
            <Flex justifyContent="center" alignItems="center" gap={3}>
              <Icons.Palette className="h-12 w-12 text-primary" />
              <Heading level={1} gradient={true} weight={800}>
                Nurav AI
              </Heading>
            </Flex>
            <Box maxWidth="768px" marginX="auto">
              ...
              >
                Experience the future of web development with our comprehensive
                design system. Advanced component architecture, intelligent
                theme management, and seamless shadcn/ui integration for
        ...
        <Flex justifyContent="center">
          <Box className="nurav-theme-controls">
            <ThemeControls />
          </Box>
        </Flex>
        ...
        <Columns count={3} minWidth="280px" gap={6}>
          <Card className="nurav-feature-card h-full">
            <CardHeader>
              <CardTitle>
            ...
            <CardContent>
              <Stack direction="vertical" spacing={4}>
                <Text variant="body-sm" color="secondary">
                  Comprehensive color tokens with automatic light/dark theme
                  support and custom theme generation.
                </Text>
          ...
          <Card className="nurav-feature-card h-full">
            ...
            <CardContent>
              <Stack direction="vertical" spacing={4}>
                <Text variant="body-sm" color="secondary">
                  Responsive typography system with multiple variants, weights,
                  and special effects like gradients.
                </Text>
                <Button variant="outline" size="sm" asChild>
                  <Link href="/core/typography">
                    View Typography
          ...
          <Card className="nurav-feature-card h-full">
            ...
            <CardContent>
              <Stack direction="vertical" spacing={4}>
                <Text variant="body-sm" color="secondary">
                  200+ carefully curated Lucide React icons with consistent
                  rounded styling and size controls.
                </Text>
                <Button variant="outline" size="sm" asChild>
                  <Link href="/core/icons">
                    Browse Icons
        ...
        {/* Technical Features */}
        <Card className="nurav-card-enhanced">
          <CardHeader>
            <CardTitle>
              <Flex alignItems="center" gap={2}>
              ...
              <Box>
                <Stack direction="vertical" spacing={3}>
                  ...
                  <Flex alignItems="center" gap={2}>
                    <Icons.Check className="h-4 w-4 text-success" />
                    <Text variant="body-sm">
                      Optimized Grid/Flex/Box components
                    </Text>
                  </Flex>
                  <Flex alignItems="center" gap={2}>
                    <Icons.Check className="h-4 w-4 text-success" />
        ...
        {/* Status */}
        <Card className="nurav-status-card">
          <CardContent>
            <Flex
